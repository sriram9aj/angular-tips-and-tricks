...
.service("UserInput", function ($rootScope, $q) {
    return {
        prompt: function (successData, failureReason, title) {
            ...
            $rootScope.$broadcast('promptUser', deferred, successData, failureReason, title || 'Choose one...');
        ...
        promptAndIncreaseExcitement: function (successData, failureReason) {
            ...
            return this.prompt(successData, failureReason).then(increaseSuccess, increaseFailure);
        },
        ...
        promptAndHideRejection: function (successData, failureReason) {
            ...
            return this.prompt(successData, failureReason).then(null, hideRejection);
        },
        ...
        promptAndConfirm: function (successData, failureReason) {
            ...
            function confirm(originalChoice) {
                return self.prompt(originalChoice + ' confirmed', originalChoice + ' rejected', 'Confirm your choice...');
            }

            return this.prompt(successData, failureReason).then(confirm, confirm);
        },
    ...
    return {
        ...
        controller: function ($scope) {
            ...
            $scope.promptUserFlexible = function () {
                $scope.result = $q.when(callAction()).then(success, failure);
                $scope.prompted = true;
            }
